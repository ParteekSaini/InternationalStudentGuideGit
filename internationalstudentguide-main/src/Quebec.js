...
import OntarioCollegesData from './OntarioCollegesData.json'
import QuebecCollegesData from './QuébecCollegesData.json'
import SaskatchewanCollegesData from './SaskatchewanCollegesData.json'
...
return (
  <div className="App container my-2">
      ...
      {QuebecCollegesData.map((clg, index) => (
        <div key={index}>
